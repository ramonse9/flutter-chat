...
import 'package:chat/pages/ordenes_detalle3_page.dart';
import 'package:chat/pages/ordenes_detalle_page.dart';
import 'package:chat/services/ordenes_service.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class Ordenes5Page extends StatefulWidget {
  const Ordenes5Page({super.key});

  @override
  State<Ordenes5Page> createState() => _Ordenes5PageState();
}

class _Ordenes5PageState extends State<Ordenes5Page> {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => OrdenDetalle3Page(),
            ),
          );
        },
